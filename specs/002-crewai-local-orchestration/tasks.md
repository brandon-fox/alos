...
- [ ] **Task 2: Dependency Addition & Configuration Wrapper** (FR-002-01)
...
- [ ] **Task 3: Custom Local Tools Implementation** (FR-002-04, FR-002-05, FR-002-06, FR-002-07)
...
- [ ] **Task 4: Declarative Configuration & CrewBase Classes** (FR-002-02, FR-002-03)
...
- [ ] **Task 5: CLI Command Extension** (FR-002-08)
  - Add `alos crew run` command to `alos/cli.py`.

- [ ] **Task 6: Pytest Suite & GitHub Actions Integration** (FR-002-09, FR-002-10)
...
- [ ] **Task 7: Quality Gates & Verification** (SC-001, SC-002, SC-003)
